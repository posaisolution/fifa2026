...
async function AlbumContent() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="rounded-xl bg-gradient-to-r from-[#1a472a] to-[#0d2b1a] p-6 text-white shadow">
...
export default function AlbumPage() {
  return (
    <Suspense fallback={<div className="py-12 text-center text-gray-400">Cargando álbum...</div>}>
      <AlbumContent />
    </Suspense>
  )
}
